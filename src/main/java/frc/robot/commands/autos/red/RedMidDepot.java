...
public class RedMidDepot extends SequentialCommandGroup{
    public RedMidDepot(CommandSwerveDrivetrain swerve, ShooterSubsystem shooter, WristSubsystem wrist, IntakeSubsystem intake, LimelightSubsystem limelight) {
    addCommands(
