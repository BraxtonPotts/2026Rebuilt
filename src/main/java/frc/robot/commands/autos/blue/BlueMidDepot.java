...
// NEED TO SET ALIGN, ADD OUTPOST?
public class BlueMidDepot extends SequentialCommandGroup{
    public BlueMidDepot(CommandSwerveDrivetrain swerve, ShooterSubsystem shooter, WristSubsystem wrist, IntakeSubsystem intake, LimelightSubsystem limelight) {
    addCommands(
        new PathPlannerAuto("BlueMidDepot"),
        ...
        Commands.runOnce(() -> intake.stop(), intake),
        new WaitCommand(1.28), //  7.78 PATH PLANNER /TIME
